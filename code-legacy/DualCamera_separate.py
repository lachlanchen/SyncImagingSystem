...
class FrameCameraController:
    ...
    def _preview_worker(self):
        ...
        # Position window on bottom half of right side of screen
        if self.screen_info:
            ...
            window_y = self.screen_info.get('bottom_half_y', 400)
...
class EventCameraController:
    ...
    def _visualization_thread(self):
        ...
        try:
            ...
            # Calculate window dimensions for top half of right side
            if self.screen_info:
                window_width = min(self.width, self.screen_info.get('right_half_width', self.width))
                window_height = min(self.height, self.screen_info.get('top_half_height', self.height) - 50)
            else:
            ...
            with MTWindow(title="Event Camera Preview", width=window_width, height=window_height,
                ...
                # Position window on top half of right side using Windows API
                    ...
                    def position_window():
                        ...
                        try:
                            ...
                            if hwnd:
                                ...
                                height = self.screen_info.get('top_half_height', 360) - 50
