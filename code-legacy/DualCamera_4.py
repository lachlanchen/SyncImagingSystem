...
class EventCameraController:
    ...
    def find_cameras(self):
        ...
        try:
            ...
            if device is not None:
                cameras.append((0, "Event Camera (Default)", device))
                # Close it for now
                try:
                    device = None
                except:
            ...
            print(f"No event camera found: {e}")
    ...
    def connect_camera(self, device=None):
        ...
        try:
            ...
            if device is None:
                ...
                self.device = initiate_device("")  # Always use default for now
    ...
    def force_disconnect(self):
        ...
        try:
            ...
            if self.device:
                try:
                    if hasattr(self.device, 'get_i_events_stream') and self.device.get_i_events_stream():
            ...
            print(f"Error in event camera force disconnect: {e}")
    ...
    def run(self):
        ...
        def on_closing():
            ...
            try:
                ...
                self.event_camera.force_disconnect()
