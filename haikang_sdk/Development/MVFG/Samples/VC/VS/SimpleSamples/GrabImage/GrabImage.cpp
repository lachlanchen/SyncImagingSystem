...
This program shows how to use the MVFGControl method to actively grab images.
...
void SaveBitImage(unsigned char* pBitMapBuf, unsigned int nBufferSize, int nImageNo)
{
    if (NULL != pBitMapBuf && 0  < nBufferSize)
    {
        ...
        sprintf_s(szFileName, FILE_NAME_LEN, "Image%d_%04d%02d%02d%02d%02d%02d%04d.bmp", nImageNo, sys.wYear, sys.wMonth,
