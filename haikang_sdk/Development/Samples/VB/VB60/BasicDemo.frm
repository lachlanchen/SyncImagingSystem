...
Private Sub CONTINUS_MODE_RADIO_Click()
    ...
    If MV_OK <> nRet Then
        MsgBox "CONTINUS_MODE_RADIO_Click error", vbDefaultButton1, "BasicDemo_VB6"
    End If
    SOFTWARE_ONCE_BUTTON.Enabled = False
End Sub
...
Private Sub ENUM_BUTTON_Click()
    ...
    If MV_OK <> nRet Then
        MsgBox "MV_CC_EnumDevices error", vbDefaultButton1, "BasicDemo_VB6"
    End If
    ...
    For i = 0 To m_stDevList.nDeviceNum - 1
        ...
        If MV_GIGE_DEVICE = stDeviceInfo.nTLayerType Then
            ...
            If stGigEInfo.chUserDefinedName(0) = 0 Then
                chGigEName = VarPtr(stGigEInfo.chModelName(0))
            Else
        ...
        ElseIf MV_USB_DEVICE = stDeviceInfo.nTLayerType Then
            ...
            Dim chName As Long
            If stUSBInfo.chUserDefinedName(0) = 0 Then
                chName = VarPtr(stUSBInfo.chModelName(0))
            Else
                chName = VarPtr(stUSBInfo.chUserDefinedName(0))
            End If
    ...
    If m_stDevList.nDeviceNum > 0 Then
        ...
        OPEN_BUTTON.Enabled = Not m_bOpenDevice
    End If
End Sub
...
Private Sub OPEN_BUTTON_Click()
    ...
    If MV_OK <> nRet Then
        MsgBox "MV_CC_CreateHandle error", vbDefaultButton1, "BasicDemo_VB6"
        Exit Sub
    End If
    ...
    If MV_OK <> nRet Then
        ...
        MsgBox "MV_CC_OpenDevice error", vbDefaultButton1, "BasicDemo_VB6"
    Exit Sub
    End If
    m_bOpenDevice = True
    ...
    Call GET_PARAMETER_BUTTON_Click
End Sub
' 保存BMP
Private Sub SAVE_BMP_BUTTON_Click()
    ...
    For i = 0 To nTestNum - 1
        ...
        If MV_OK = nRet Then
            ...
            If MV_OK <> nRet Then
                MsgBox "MV_CC_SaveImage error", vbDefaultButton1, "BasicDemo_VB6"
                Exit Sub
            End If
            
            Open ("Data.bmp") For Binary As #2
                Put #2, , pImageBuf
            
            Close #2
            Set ts = Nothing
            MsgBox "Save Bmp succeed!", vbDefaultButton1, "BasicDemo_VB6"
            Exit Sub
        Else
            Sleep (4)
        End If
    ...
    MsgBox "No Data!", vbDefaultButton1, "BasicDemo_VB6"
    Set ts = Nothing
End Sub
' 保存JPG
Private Sub SAVE_JPG_BUTTON_Click()
    ...
    For i = 0 To nTestNum - 1
        ...
        If MV_OK = nRet Then
            ...
            Open ("Data.jpg") For Binary As #2
                Put #2, , pImageBuf
            Close #2
            
            Set ts = Nothing
            MsgBox "Save Jpg succeed!", vbDefaultButton1, "BasicDemo_VB6"
            Exit Sub
        Else
            Sleep (4)
        End If
...
Private Sub SET_PARAMETER_BUTTON_Click()
    ...
    fExposureTime = Val(EXPOSURE_EDIT.Text)
    fGain = Val(GAIN_EDIT.Text)
    fFrameRate = Val(FRAME_RATE_EDIT.Text)
    

ErrorHandler:
    If Err.Number <> 0 Then
        MsgBox "Incorrect parameter format", vbDefaultButton1, "BasicDemo_VB6"
        Exit Sub
    End If
    ...
    If MV_OK <> nRet Then
        MsgBox "Set ExposureTime error", vbDefaultButton1, "BasicDemo_VB6"
    End If
    
    nRet = MV_CC_SetEnumValue(m_pHandle, "GainAuto", 0)
    nRet = MV_CC_SetFloatValue(m_pHandle, "Gain", GAIN_EDIT.Text)
    If MV_OK <> nRet Then
        MsgBox "Set Gain error", vbDefaultButton1, "BasicDemo_VB6"
    End If
    
    nRet = MV_CC_SetFloatValue(m_pHandle, "AcquisitionFrameRate", FRAME_RATE_EDIT.Text)
    If MV_OK <> nRet Then
        MsgBox "Set AcquisitionFrameRate error", vbDefaultButton1, "BasicDemo_VB6"
    End If
End Sub
' 软触发一次
Private Sub SOFTWARE_ONCE_BUTTON_Click()
    ...
    If MV_OK <> nRet Then
        MsgBox "Set TriggerSoftware error", vbDefaultButton1, "BasicDemo_VB6"
        Exit Sub
    End If
End Sub
' 设置软触发
Private Sub SOFTWARE_TRIGGER_CHECK_Click()
    ...
    If 1 = SOFTWARE_TRIGGER_CHECK.Value Then
        ...
        If MV_OK <> nRet Then
            MsgBox "Set TriggerSource error", vbDefaultButton1, "BasicDemo_VB6"
            Exit Sub
        End If
        SOFTWARE_ONCE_BUTTON.Enabled = True
    Else
...
Private Sub START_GRABBING_BUTTON_Click()
    ...
    If MV_OK <> nRet Then
        MsgBox "MV_CC_StopGrabbing error", vbDefaultButton1, "BasicDemo_VB6"
        Exit Sub
    End If
    
    nRet = MV_CC_Display(m_pHandle, PICTURE_DISPLAY.hWnd)
    If MV_OK <> nRet Then
        MsgBox "MV_CC_Display error", vbDefaultButton1, "BasicDemo_VB6"
        Exit Sub
    End If
...
Private Sub TRIGGER_MODE_RADIO_Click()
    ...
    If MV_OK <> nRet Then
        MsgBox "TRIGGER_MODE_RADIO_Click error", vbDefaultButton1, "BasicDemo_VB6"
    End If
