...
public class SaveImage
{
    ...
    public static void saveDataToFile(byte[] dataToSave, int dataSize, String fileName)
    {
        ...
        try
        {
			...
			{
				System.err.println("SaveImage failed!");
			}
    ...
    public static void main(String[] args)
    {
        ...
        do
        {
            ...
            // Get one frame, High-resolution pictures need to be obtained in a loop
            ...
            int imageLen = stImageInfo.ExtendWidth * stImageInfo.ExtendHeight * 3;    // Every RGB pixel takes 3 bytes
            ...
            stSaveParam.width = stImageInfo.ExtendWidth;                                  // image width
            stSaveParam.height = stImageInfo.ExtendHeight;                                // image height
            ...
            stSaveParam.methodValue = 1;                                            // Interpolation method that converts Bayer format to RGB24.  0-Neareast 1-double linear 2-Hamilton
