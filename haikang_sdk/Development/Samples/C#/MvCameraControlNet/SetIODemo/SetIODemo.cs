...
namespace SetIODemo
{
    public partial class SetIODemo : Form
    {
        ...
        public SetIODemo()
        {
            ...
            this.Load += new EventHandler(this.SetIODemo_Load);
        }

        private void SetIODemo_Load(object sender, EventArgs e)
        {
        ...
        private void SetIODemo_FormClosing(object sender, FormClosingEventArgs e)
        {
