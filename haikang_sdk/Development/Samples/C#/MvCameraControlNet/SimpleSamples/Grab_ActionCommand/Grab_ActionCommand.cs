      ...
      public unsafe static T[] PtrToStructurs<T>(IntPtr pt, int lenth)
        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                nRet = device.MV_CC_SetEnumValueByString_NET("TriggerSource", "Action1");
                if (MyCamera.MV_OK != nRet)
                {
                ...
                nRet = device.MV_CC_SetIntValueEx_NET("ActionDeviceKey", g_DeviceKey);
                if (MyCamera.MV_OK != nRet)
                {
                ...
                nRet = device.MV_CC_SetIntValueEx_NET("ActionGroupKey", g_GroupKey);
                if (MyCamera.MV_OK != nRet)
                {
                ...
                nRet = device.MV_CC_SetIntValueEx_NET("ActionGroupMask", g_GroupMask);
                if (MyCamera.MV_OK != nRet)
                {
