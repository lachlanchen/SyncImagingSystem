...
namespace ReconnectDemo
{
    public partial class ReconnectDemo : Form
    {
        ...
        public ReconnectDemo()
        {
            ...
            this.Load += new EventHandler(this.ReconnectDemo_Load);
        }

        private void ReconnectDemo_Load(object sender, EventArgs e)
        {
        ...
        private void DeviceListAcq()
        {
            ...
            for (int i = 0; i < m_stDeviceList.nDeviceNum; i++)
            {
                ...
                if (device.nTLayerType == MyCamera.MV_GIGE_DEVICE)
                {
                    ...
                    MyCamera.MV_GIGE_DEVICE_INFO_EX gigeInfo = (MyCamera.MV_GIGE_DEVICE_INFO_EX)Marshal.PtrToStructure(buffer, typeof(MyCamera.MV_GIGE_DEVICE_INFO_EX));
                ...
                else if (device.nTLayerType == MyCamera.MV_USB_DEVICE)
                {
                    ...
                    MyCamera.MV_USB3_DEVICE_INFO_EX usbInfo = (MyCamera.MV_USB3_DEVICE_INFO_EX)Marshal.PtrToStructure(buffer, typeof(MyCamera.MV_USB3_DEVICE_INFO_EX));
