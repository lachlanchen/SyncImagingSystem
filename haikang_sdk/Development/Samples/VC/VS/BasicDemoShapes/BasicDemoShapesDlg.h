...
// BasicDemoShapesDlg.h : header file
#pragma once
#include "afxwin.h" 
#include "MvCamera.h"

// CBasicDemoShapesDlg dialog
class CBasicDemoShapesDlg : public CDialog
{
// Construction
public:
	CBasicDemoShapesDlg(CWnd* pParent = NULL);	// Standard constructor

    // Dialog Data
	enum { IDD = IDD_BasicDemoShapes_DIALOG };
...
private:
    ...
    BOOL                    m_bDrawRectCheck;               // ch:是否选中“绘制矩形” | en:Is "Draw Rect" checked
    BOOL                    m_bDrawCircleCheck;             // ch:是否选中“绘制圆形” | en:Is "Draw Circle" checked
    BOOL                    m_bDrawLineCheck;               // ch:是否选中“绘制线条” | en:Is "Draw Line" checked
...
public:
    ...
    /*ch:图形绘制 | en:Draw Shapes*/
    afx_msg void OnBnClickedDrawRectCheck();            // ch:绘制矩形 | en:Draw Rectangle
    afx_msg void OnBnClickedDrawCircleCheck();          // ch:绘制圆形 | en:Draw Circle
    afx_msg void OnBnClickedDrawLine();                 // ch:绘制线条 | en:Draw Line
