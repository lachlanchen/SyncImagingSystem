...
int main()
{
    ...
    do 
    {
        ...
        {
			if (pAccessMode == AM_RW || pAccessMode == AM_WO)
			{
        ...
        pSaveImageBuf = (unsigned char*)malloc(nPayloadSize * nImageNum);
        ...
        pDstImageBuf = (unsigned char*)malloc(stSavePoCloudPar.nLineNum * stSavePoCloudPar.nLinePntNum * (16 * 3 + 4) + 2048);
