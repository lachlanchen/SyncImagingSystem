/*
 * 这个示例演示了如何用DirectShow插件从相机中获取图像，暂不支持在相机的LineScan模式下取图.
 * This example demonstrates how to use the DirectShow plugin to retrieve images from a camera, which is currently not supported in LineScan mode of the camera
 * 
 */
